...
def handle_query(query_text, channel, mw_filter):
    ...
    top_search_results_df = smart3wrapper.cached_search_smart3(nmr_data_df, output_image=output_nmr_image, channel=int(channel), mw_filter=mw_filter)
